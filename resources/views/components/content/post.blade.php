...
&lt;/dl&gt;                            
                ...
                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Configure Tailwind CSS and Flowbite before
                    copying the code</p>
            </div>
            <h4 class="text-lg font-semibold mb-2">Table example</h4>
            <p class="mb-4 text-gray-600 dark:text-gray-400">A serif is a small shape or projection that appears at
                the
            ...
            <table class="min-w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
                <thead class="bg-gray-50 dark:bg-gray-700">
                    <tr>
                        <th
                            class="py-2 px-4 border-b border-gray-200 dark:border-gray-700 text-left text-sm font-semibold text-gray-600 dark:text-gray-300">
                            Country</th>
                        <th
                            class="py-2 px-4 border-b border-gray-200 dark:border-gray-700 text-left text-sm font-semibold text-gray-600 dark:text-gray-300">
                            Date &amp; Time</th>
                ...
                <tbody>
                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                        <td class="py-2 px-4 border-b border-gray-200 dark:border-gray-700">United States</td>
                        <td class="py-2 px-4 border-b border-gray-200 dark:border-gray-700">April 21, 2021</td>
                        <td class="py-2 px-4 border-b border-gray-200 dark:border-gray-700"><strong>$2,300</strong>
                        </td>
                    </tr>
                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                        <td class="py-2 px-4 border-b border-gray-200 dark:border-gray-700">Canada</td>
                        <td class="py-2 px-4 border-b border-gray-200 dark:border-gray-700">May 31, 2021</td>
                        <td class="py-2 px-4 border-b border-gray-200 dark:border-gray-700"><strong>$300</strong>
                        </td>
                    </tr>
                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                        <td class="py-2 px-4 border-b border-gray-200 dark:border-gray-700">United Kingdom</td>
                        <td class="py-2 px-4 border-b border-gray-200 dark:border-gray-700">June 3, 2021</td>
                        <td class="py-2 px-4 border-b border-gray-200 dark:border-gray-700"><strong>$2,500</strong>
                        </td>
                    </tr>
                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                        <td class="py-2 px-4 border-b border-gray-200 dark:border-gray-700">Australia</td>
                        <td class="py-2 px-4 border-b border-gray-200 dark:border-gray-700">June 23, 2021</td>
                        <td class="py-2 px-4 border-b border-gray-200 dark:border-gray-700"><strong>$3,543</strong>
                        </td>
                    </tr>
                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                        <td class="py-2 px-4 border-b border-gray-200 dark:border-gray-700">Germany</td>
                        <td class="py-2 px-4 border-b border-gray-200 dark:border-gray-700">July 6, 2021</td>
                        <td class="py-2 px-4 border-b border-gray-200 dark:border-gray-700"><strong>$99</strong>
                        </td>
                    </tr>
                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                        <td class="py-2 px-4 border-b border-gray-200 dark:border-gray-700">France</td>
                        <td class="py-2 px-4 border-b border-gray-200 dark:border-gray-700">August 23, 2021</td>
                        <td class="py-2 px-4 border-b border-gray-200 dark:border-gray-700"><strong>$2,540</strong>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <section class="not-format">
                ...
                <form class="mb-6">
                    <div class="mb-4 bg-white border-gray-200 dark:bg-gray-800 dark:border-gray-700">
