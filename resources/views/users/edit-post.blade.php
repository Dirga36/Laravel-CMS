...
@section('content')
    <section class="antialiased py-8 md:py-16 text-black">
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12 space-y-5">
            <div class="p-4 text-black bg-slate-50 dark:bg-slate-700 dark:text-white rounded-lg shadow-lg">
                <form action="{{ route('posts.update', $post->id) }}" method="POST" class="space-y-4"
                    ...
                    <div>
                        <!-- Title input field -->
                        <label for="title" class="block text-xl font-medium text-gray-700 dark:text-gray-300">Title</label>
                    ...
                    <div>
                        ...
                        @if ($post->image)
                            <div class="basis-1/4 p-0 content-center justify-center">
                                <label for="image" class="block text-xl font-medium text-gray-700 dark:text-gray-300">Image</label>
